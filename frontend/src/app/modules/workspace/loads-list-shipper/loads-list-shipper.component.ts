...
import { first, filter, switchMap, map, catchError, EMPTY } from 'rxjs';
import { LoadsListTable, LoadsList } from 'src/app/models/load.model';
import { DialogService } from 'src/app/services/dialog.service';
import { LoadService } from 'src/app/services/load.service';
import { NotificationService } from 'src/app/services/notification.service';

@Component({
  selector: 'app-loads-list-shipper',
  templateUrl: './loads-list-shipper.component.html',
  styleUrls: ['./loads-list-shipper.component.scss']
})
export class LoadsListShipperComponent implements OnInit {
